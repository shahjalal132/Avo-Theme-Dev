...
<!-- Mirrored from ui-themez.smartinnovates.net/items/avo/avo-dark/index5.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 27 Jul 2023 07:08:32 GMT -->
<head>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="cont">
                        ...
                        <p class="wow fadeInUp" data-wow-delay=".5s">Hello! I’m Alex Smith. Web designer from USA, California, San Francisco. I have rich
                            experience in web site design and building, also I am good at wordpress. I love to talk with
                ...
                <div class="col-lg-6 valign">
                    <div class="skills-box full-width">
                        ...
                        <div class="skill-item">
                            <h6 class="custom-font">Development</h6>
                            <div class="skill-progress">
                                <div class="progres custom-font" data-value="80%"></div>
                            </div>
                        </div>
                        <div class="skill-item">
                            <h6 class="custom-font">Graphic Design</h6>
                            <div class="skill-progress">
                                <div class="progres custom-font" data-value="88%"></div>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <section class="contact-sec section-padding">
        <div class="container">
            ...
            <div class="row justify-content-center wow fadeInUp" data-wow-delay=".5s">
                <div class="col-lg-10">
                    <div class="form">
                        <form id="contact-form" method="post" action="https://ui-themez.smartinnovates.net/items/avo/avo-dark/contact.php">
...
<!-- Mirrored from ui-themez.smartinnovates.net/items/avo/avo-dark/index5.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 27 Jul 2023 07:08:33 GMT -->
</html>