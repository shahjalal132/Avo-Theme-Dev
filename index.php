        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="cont">
                    ...
                    <h3 class="main-title wow" data-splitting>My mission is design develop the best Websites around.
                    </h3>
                    <p class="wow fadeInUp" data-wow-delay=".5s">Hello! I’m Alex Smith. Web designer from USA,
                        California, San Francisco. I have rich
                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="text-center">
                                        <button type="submit" class="simple-btn custom-font cursor-pointer"><span>Send
                                                Message</span></button>
                                    </div>
                                </div>
                            </div>
